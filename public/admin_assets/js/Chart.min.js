                            ...
                            e.extend(t.Controller.prototype, {
                                ...
                                eventHandler: function (t) {
                                    ...
                                    return (
                                        ...
                                        "mouseout" === t.type ? ((a.active = []), (a.tooltipActive = [])) : ((a.active = a.getElementsAtEventForMode(t, o.mode)), (a.tooltipActive = a.getElementsAtEventForMode(t, r.mode))),
                                        o.onHover && o.onHover.call(a, a.active),
                                        ("mouseup" === t.type || "click" === t.type) && (n.onClick && n.onClick.call(a, t, a.active), a.legend && a.legend.handleEvent && a.legend.handleEvent(t)),
                                        ...
                                        i.pivot(),
                                        a.animating || (e.arrayEquals(a.active, a.lastActive) && e.arrayEquals(a.tooltipActive, a.lastTooltipActive)) || (a.stop(), (r.enabled || r.custom) && i.update(!0), a.render(o.animationDuration, !0)),
                    ...
                    e.exports = function (t) {
                        ...
                        t.layoutService = {
                            ...
                            update: function (t, a, i) {
                                ...
                                function l(t) {
                                    t.isHorizontal()
                                        ? ((t.left = t.options.fullWidth ? s : C), (t.right = t.options.fullWidth ? a - s : C + k), (t.top = F), (t.bottom = F + t.height), (F = t.bottom))
                            ...
                            (t.Legend = t.Element.extend({
                                ...
                                draw: function () {
                                    ...
                                    if (i.display) {
                                        ...
                                        (u.textAlign = "left"), (u.textBaseline = "top"), (u.lineWidth = 0.5), (u.strokeStyle = h), (u.fillStyle = h), (u.font = m);
                                        var b = n.boxWidth,
                                            v = a.legendHitBoxes,
                                            x = function (e, a, n) {
                                                if (!(isNaN(b) || 0 >= b)) {
                                        ...
                                        e.each(a.legendItems, function (t, e) {
                                            var i = u.measureText(t.text).width,
                                                ...
                                                r = d.x,
                                                c = d.y;
                                            k ? r + o >= l && ((c = d.y += S), d.line++, (r = d.x = a.left + (l - s[d.line]) / 2)) : c + S > a.bottom && ((r = d.x = r + a.columnWidths[d.line] + n.padding), (c = d.y = a.top), d.line++),
                                                x(r, c, t),
                                                (v[e].left = r),
                                                (v[e].top = c),
                                                y(r, c, t, i),
                                    ...
                                    if (n.display) {
                                        ...
                                        if (g) {
                                            if (
                                                ((o = !1),
                                                h && (T /= 2),
                                                (T + d.autoSkipPadding) * i.ticks.length > i.width - (i.paddingLeft + i.paddingRight) &&
                                                    (o = 1 + Math.floor(((T + d.autoSkipPadding) * i.ticks.length) / (i.width - (i.paddingLeft + i.paddingRight)))),
                                                r && i.ticks.length > r)
                                            )
                                        ...
                                        if (
                                            ...
                                            if (g) (O = i.left + (i.right - i.left) / 2), (B = "bottom" === n.position ? i.bottom - C / 2 : i.top + C / 2);
                                                ...
                                                (O = z ? i.left + C / 2 : i.right - C / 2), (B = i.top + (i.bottom - i.top) / 2), (W = z ? -0.5 * Math.PI : 0.5 * Math.PI);
                                            }
                                        ...
                                        if (u.drawBorder) {
                                            ...
                                            g ? ((E = U = "top" === n.position ? i.bottom : i.top), (E += q), (U += q)) : ((N = H = "left" === n.position ? i.right : i.left), (N += q), (H += q)),
                                                l.beginPath(),
                                                l.moveTo(N, E),
                                                l.lineTo(H, U),
                                                l.stroke();
                            ...
                            draw: function () {
                                ...
                                if (o.display) {
                                    ...
                                    (i.fillStyle = n(o.fontColor, r.defaultFontColor)),
                                        (i.font = h),
                                        a.isHorizontal() ? ((l = p + (b - p) / 2), (s = g + (m - g) / 2)) : ((l = "left" === o.position ? p + d / 2 : b - d / 2), (s = g + (m - g) / 2), (f = Math.PI * ("left" === o.position ? -0.5 : 0.5))),
                                        i.save(),
                                        i.translate(l, s),
                                        i.rotate(f),
                                        (i.textAlign = "center"),
                            ...
                            (t.Tooltip = t.Element.extend({
                                ...
                                drawCaret: function (t, e, a) {
                                    var i,
                                        ...
                                        x = e.height;
                                    "center" === p
                                        ? ("left" === g ? ((i = m), (o = i - h), (r = i)) : ((i = m + v), (o = i + h), (r = i)), (s = b + x / 2), (l = s - h), (d = s + h))
                                        : ("left" === g ? ((i = m + f), (o = i + h), (r = o + h)) : "right" === g ? ((i = m + v - f), (o = i - h), (r = o - h)) : ((o = m + v / 2), (i = o - h), (r = o + h)),
                                ...
                                draw: function () {
                                    function t(t, e) {
                                        ...
                                        e._view.steppedLine === !0
                                            ? (s.lineTo(e._view.x, t._view.y), s.lineTo(e._view.x, e._view.y))
                                            : 0 === e._view.tension
                                            ? s.lineTo(a.x, a.y)
                ...
                function (t, e, a) {
                    ...
                    e.exports = function (t) {
                        var e = t.helpers,
                            a = t.defaults.global,
                            i = a.defaultColor;
                        (a.elements.point = { radius: 3, pointStyle: "circle", backgroundColor: i, borderWidth: 1, borderColor: i, hitRadius: 1, hoverRadius: 4, hoverBorderWidth: 1 }),
                            ...
                            i = t.Scale.extend({
                                ...
                                buildTicks: function () {
                                    for (var t = this, a = t.options, i = a.ticks, n = e.getValueOrDefault, o = (t.ticks = []), r = n(i.min, Math.pow(10, Math.floor(e.log10(t.min)))); r < t.max; ) {
                                        o.push(r);
                                        var l, s;
                                        0 === r ? ((l = Math.floor(e.log10(t.minNotZero))), (s = Math.round(t.minNotZero / Math.pow(10, l)))) : ((l = Math.floor(e.log10(r))), (s = Math.floor(r / Math.pow(10, l)) + 1)),
                                            10 === s && ((s = 1), ++l),
                                            (r = s * Math.pow(10, l));
                                    }
                                    var d = n(i.max, r);
