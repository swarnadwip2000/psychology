                        ...
                        <div class="col-md-6">
                            <div class="form-group-div">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="floatingInputValue" name="institute_name"
                                        value="{{ old('institute_name') }}" placeholder="School Name*">
                            ...
                            <div class="form-group-div">
                                <div class="form-group">
                                    ...
                                    <select name="student_age" id="student_age" class="form-control">
                                        <option value="">Select</option>
                                        @for ($i = 20; $i < 45; $i++)
                                            <option value="{{ $i }}" {{ old('student_age') == $i ? 'selected' : '' }}>{{ $i }}</option>
                                        @endfor
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="student_class" id="student_class" class="form-control">
                                        ...
                                        @foreach (config('class.school_class') as $key => $val)
                                            <option value="{{ $key }}" {{ old('student_class') == $key ? 'selected' : '' }}>{{ $val }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group-div">
                                <div class="form-group">
                                    ...
                                    <select name="register_as" id="register_as" class="form-control">
                                        <option value="">Select Status</option>
                                        <option value="1" {{ old('register_as') == 1 ? 'selected' : '' }}>School</option>
                                        <option value="2" {{ old('register_as') == 2 ? 'selected' : '' }}>Collage</option>
                                    </select>
