                ...
                <div class="col-md-12">
                    <div class="row justify-content-center">
                        <form action="{{ route('front.registration_success') }}" method="POST" onsubmit="return valid()">
                            @csrf()
                            <input type="hidden" name="register_as" value="2">
                            <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="school_name" name="school_name" placeholder="College Name">
                            </div>
    ...
    <script>
        function valid() {
            if($("#student_age").val() == ''){
                ...
                toastr.error('Enter your College name!!');
                return false;
            }
