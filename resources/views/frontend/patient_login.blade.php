            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="row justify-content-center">
                        <form action="{{ route('front.patient_login') }}" method="POST" onsubmit="return valid()">
                            @csrf()
                            ...
                            <div class="text-center">
                                <a href="{{route('front.patient.forget_password')}}">Forget Password</a>
                            </div>
                            <div class="col-md-12 text-center">
                                <span>New Register <a href="{{ route('front.patient_registration') }}">here</a> | <a href="{{ route('front.student_login') }}">Student Login</a></span>
                                <br/>
